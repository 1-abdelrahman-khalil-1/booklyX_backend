...
const ar = {
  ...
  OFFER_CLAIMED_SUCCESSFULLY: "تم الحصول على العرض بنجاح.",
  CLAIMED_OFFERS_RETRIEVED_SUCCESSFULLY: "تم استرجاع العروض التي تم الحصول عليها بنجاح.",
  OFFER_ALREADY_CLAIMED: "لقد حصلت بالفعل على هذا العرض.",
  OFFER_ALREADY_IN_USE: "هذا العرض مستخدم بالفعل في أحد حجوزاتك النشطة.",
