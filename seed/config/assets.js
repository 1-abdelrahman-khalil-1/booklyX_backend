export const ASSETS = {
  profileImages: {
    // Strictly male doctor portrait photos
    doctors: [
    ...
    // Strictly male barber/grooming professional portrait photos
    barbers: [
    ...
    // Strictly male spa/wellness specialist portrait photos
    spa: [
    ...
    // Strictly male client portrait photos
    clients: [
      ...
      "https://images.unsplash.com/photo-1548372290-8d01b6c8e78c?auto=format&fit=crop&w=500&q=80",
      "https://images.unsplash.com/photo-1540569014015-19a7be504e3a?auto=format&fit=crop&w=500&q=80",
      "https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?auto=format&fit=crop&w=500&q=80",
      "https://images.unsplash.com/photo-1546961342-ea5f62d951f1?auto=format&fit=crop&w=500&q=80",
      "https://images.unsplash.com/photo-1566492031773-4f4e44671857?auto=format&fit=crop&w=500&q=80",
    ],
  },

  // Professional certificate / document placeholder images
  certificates: [
    "https://images.unsplash.com/photo-1589330694653-ded6df53f6ee?auto=format&fit=crop&w=500&q=80",
    ...
    "https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?auto=format&fit=crop&w=500&q=80",
    "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=500&q=80",
  ],

  // Service execution result/before-after photos (male subjects or tools/environment)
  executionAttachments: {
    barber: [
      ...
      "https://images.unsplash.com/photo-1593702295094-aea22597af65?auto=format&fit=crop&w=500&q=80",
  ...
  // Service listing card images — show the work/environment, not people
  serviceImages: {
    barber: [
      "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&w=500&q=80",
      "https://images.unsplash.com/photo-1621605815971-fbc98d665033?auto=format&fit=crop&w=500&q=80",
  ...
  // Branch/business hero images — show the location or environment
  businessImages: {
    barber: [
      "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&w=500&q=80",
      "https://images.unsplash.com/photo-1585747860715-2ba37e788b70?auto=format&fit=crop&w=500&q=80",
